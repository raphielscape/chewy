...
function db_stat
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"$FILE\"}" "$API_METADATA_URL" 2> /dev/null
    check_http_response
...
function db_chunked_upload_file
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Dropbox-API-Arg: {\"close\": false}" --header "Content-Type: application/octet-stream" --data-binary @/dev/null "$API_CHUNKED_UPLOAD_START_URL" 2> /dev/null
    check_http_response
    ...
    while ([[ $OFFSET != "$FILE_SIZE" ]]); do
        ...
        #Uploading the chunk...
        echo > "$RESPONSE_FILE"
        $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST $CURL_PARAMETERS --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Dropbox-API-Arg: {\"cursor\": {\"session_id\": \"$SESSION_ID\",\"offset\": $OFFSET},\"close\": false}" --header "Content-Type: application/octet-stream" --data-binary @"$CHUNK_FILE" "$API_CHUNKED_UPLOAD_APPEND_URL"
...
function db_download_file
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES $CURL_PARAMETERS -X POST --globoff -D "$RESPONSE_FILE" -o "$FILE_DST" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Dropbox-API-Arg: {\"path\": \"$FILE_SRC\"}" "$API_DOWNLOAD_URL"
    check_http_response
...
function db_saveurl
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"$FILE_DST/$FILE_NAME\", \"url\": \"$URL\"}" "$API_SAVEURL_URL" 2> /dev/null
    check_http_response
    ...
    while (true); do
        ...
        $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"async_job_id\": \"$JOB_ID\"}" "$API_SAVEURL_JOBSTATUS_URL" 2> /dev/null
        check_http_response
...
function db_account_info
{
    ...
    print " > Getting info... "
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" "$API_ACCOUNT_INFO_URL" 2> /dev/null
    check_http_response
...
function db_account_space
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" "$API_ACCOUNT_SPACE_URL" 2> /dev/null
    check_http_response
...
function db_delete
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"$FILE_DST\"}" "$API_DELETE_URL" 2> /dev/null
    check_http_response
...
function db_move
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"from_path\": \"$FILE_SRC\", \"to_path\": \"$FILE_DST\"}" "$API_MOVE_URL" 2> /dev/null
    check_http_response
...
function db_copy
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"from_path\": \"$FILE_SRC\", \"to_path\": \"$FILE_DST\"}" "$API_COPY_URL" 2> /dev/null
    check_http_response
...
function db_mkdir
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"$DIR_DST\"}" "$API_MKDIR_URL" 2> /dev/null
    check_http_response
...
function db_list_outfile
{
    ...
    while (true); do
        ...
        if [[ $HAS_MORE == "true" ]]; then
            $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"cursor\": \"$CURSOR\"}" "$API_LIST_FOLDER_CONTINUE_URL" 2> /dev/null
        else
            $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"$DIR_DST\",\"include_media_info\": false,\"include_deleted\": false,\"include_has_explicit_shared_members\": false}" "$API_LIST_FOLDER_URL" 2> /dev/null
        fi
...
function db_share
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"$FILE_DST\",\"settings\": {\"requested_visibility\": \"public\"}}" "$API_SHARE_URL" 2> /dev/null
    check_http_response
...
{
    local FILE_DST=$(normalize_path "$1")
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"$FILE_DST\",\"direct_only\": true}" "$API_SHARE_LIST"
    check_http_response
...
function db_search
{
    ...
    $CURL_BIN $CURL_ACCEPT_CERTIFICATES -X POST -L -s --show-error --globoff -i -o "$RESPONSE_FILE" --header "Authorization: Bearer B9-iBbEgCXAAAAAAAAAAB_L4M9iFMRHHx-uj8dgnUvcuODT8UsOWtaYbHxZbrtTw" --header "Content-Type: application/json" --data "{\"path\": \"\",\"query\": \"$QUERY\",\"start\": 0,\"max_results\": 1000,\"mode\": \"filename\"}" "$API_SEARCH_URL" 2> /dev/null
    check_http_response
