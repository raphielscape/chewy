...
echo "  echo 103680 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq" >> /system/vendor/bin/init.qcom.post_boot.sh
else
echo "  echo 140160 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq" >> /system/vendor/bin/init.qcom.post_boot.sh
fi
